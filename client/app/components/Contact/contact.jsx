    ...
    return (
        <div className="z-0 mt-[2px]">
                ...
                <div>
                    <div >
                        <div className='flex  text-[#9c3353] py-4 mb-3 text-2xl max-w-[200px]'>
                            <span className='w-[50%]'><HiLocationMarker />
                                INDIA
                            </span>
                        </div>


                        <h3 >Panipat Institute of Engineering and Technology, Samalkha</h3>
                        <p></p>
                    </div>
                    <div className='text-[#9c3353] underline'>
                        <div className="block m-1">
                            <AiFillMail className='inline-block mr-1 text-black' />
                            <a className='hover:hover:decoration-white' href="mailto:HopeFundpiet@gmail.com">hopefundpiet@gmail.com</a>
                        </div>
                        <div className="block m-1">
                            <BsFillTelephoneFill className='inline-block mr-2 text-black' />
                            <a className='hover:decoration-white' href="tel:+917206617818">7206617818</a>/
                            <a className='hover:decoration-white' href="tel:+918448962527">8448962527</a>
                        </div>
            ...
            <div className="w-full px-5 py-10 max-w-[1200px] m-auto">
                <iframe className="w-full border-0" src={"https://www.google.com/maps/place//@29.0075732,77.0449321,15z/data=!3m1!4b1?entry=ttu"} width={1000} height={450} allowFullScreen={""} loading={"lazy"} referrerPolicy={"no-referrer-when-downgrade"}></iframe>
            </div>
            <div className='w-full px-5 py-10 max-w-[1200px] m-auto'>
