                ...
                <div className="mb-2 md:flex md:justify-between">
                    ...
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                        ...
                        <div>
                            ...
                            <ul className="font-medium text-gray-500">
                                <li className="mb-4">
                                    <a href="https://github.com/Rohit-GHacc/HOPEFUND" target='_blank' className="hover:underline ">Github</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/rohit-chugh14/" target='_blank' className="hover:underline">Linked in</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            ...
                            <ul className="font-medium text-gray-500">
                                <li className="mb-4 hover:underline">
                                    Call Us: +91-720-661-7818 / +91-844-896-2527
                                </li>
                                <li className='hover:underline'>
                                    Address: PIET Samalkha, 132101
                                </li>
                            </ul>
                        </div>
                    </div>
